...
function validateForm() {
    ...
    var check1 = true; // Initialize check1 and check2 to true
    var check2 = true;
    ...
    if (password !== confirmPassword) {
        ...
        check1 = false; // Prevent form submission
    }
...
<nav>
    <div class="navbar">
      ...
      <div class="nav-links">
        ...
        <ul class="links">
          <li><a href="./Specialities.html">CenterOfExcellence</a></li>
          <li>
...
<div class="login-page-cont">
    <div class="forms-cont" id="signInSection">
        ...
        <form class="form-inputs" action="/add_patient" method="post" onsubmit="return validateForm();" th:object="${sp2}" name="loginForm">
            <p class="auth-logo">
                ...
                <div class="form-group">
                    <label class="input-label" for="inputPassword"><i class="fas fa-key"></i> Create Password</label>
                    <input type="password" class="form-control" name="password" id="password"
                        placeholder="example@123" />
                </div>
                 <div class="form-group">
                    <label class="input-label" for="inputPassword"><i class="fas fa-key"></i> Confirm Password</label>
       ...
       <a href="/login">
        <button type="button" class="btn signin-btn" id="goToLoginInSection">
            <span id="login"></span>
