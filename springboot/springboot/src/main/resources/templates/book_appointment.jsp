...
<br>
   ...
   <div class="card-container">
     <!-- Create a card element for Dr. Ajay Bahadur -->
     <div class="card">
       <!-- Create a card picture -->
       <img src="https://cdn.askapollo.com/live/images/doctors/cardiology/dr-ajay-bahadur-cardiology-in-lucknow.png" alt="Doctor">
       <!-- Create a card name -->
       <h1>Dr. Ajay Bahadur</h1>
       <!-- Create a card details -->
       <p>Cardiologist</p>
       <p>13 years of experience</p>
       <p>Kapur Road, Lucknow</p>
       <p>Mon-Sat, 10 AM - 5 PM</p>
       <!-- Create a button to book an appointment -->
       <a href="/appointment">
       <button onclick="bookAppointment('Dr. Ajay Bahadur')">Book an Appointment</button>
       </a>
     </div>

     <!-- Create a card element for Dr. Akhilesh Jain -->
     <div class="card">
       <!-- Create a card picture -->
       <img src="https://cdn.askapollo.com/live/images/doctors/cardiology/dr-akhilesh-jain-cardiology-in-indore..jpeg" alt="Doctor">
       <!-- Create a card name -->
       <h1>Dr. Akhilesh Jain</h1>
       <!-- Create a card details -->
       <p>Neurology</p>
       ...
       <!-- Create a button to book an appointment -->
       <a href="/appointment">
       <button onclick="bookAppointment('Dr. Akhilesh Jain')">Book an Appointment</button>
       </a>
     </div>
    ...
    <div class="card">
      <!-- Create a card picture -->
      <img src="https://cdn.askapollo.com/live/images/doctors/cardiology/dr-a-sreenivas-kumar-cardiology-in-hyderabad.png" alt="Doctor">
      <!-- Create a card name -->
      <h1>Dr A Sreenivas Kumar</h1>
      <!-- Create a card details -->
      <p>Orthopaedic</p>
      <p>5 years of experience</p>
      <p>Vijay Nagar, Indore</p>
      ...
      <!-- Create a button to book an appointment -->
      <a href="/appointment">
      <button onclick="bookAppointment('Dr A Sreenivas Kumar')">Book an Appointment</button>
      </a>
    </div>
    <div class="card">
      <!-- Create a card picture -->
      <img src="https://cdn.askapollo.com/live/images/doctors/cardiology/dr-abhijit-vilas-kulkarni-cardiology-in-bangalore.png" alt="Doctor">
      <!-- Create a card name -->
      <h1>Dr A Ashesh Kumar</h1>
      <!-- Create a card details -->
      <p>Oncology</p>
      <p>5 years of experience</p>
      <p>Vijay Nagar, Indore</p>
    ...
    <div class="card">
      <!-- Create a card picture -->
      <img src="https://cdn.askapollo.com/live/images/doctors/cardiology/dr-anuradha-sridhar-cardiology-in-chennai.png" alt="Doctor">
      <!-- Create a card name -->
      <h1>Dr Anuradha Sridhar</h1>
      <!-- Create a card details -->
      <p>Gynecology</p>
      <p>5 years of experience</p>
      <p>Vijay Nagar, Indore</p>
      ...
      <!-- Create a button to book an appointment -->
      <a href="/appointment">
      <button onclick="bookAppointment('Dr Anuradha Sridhar')">Book an Appointment</button>
      </a>
    </div>
    <div class="card">
      <!-- Create a card picture -->
      <img src="https://cdn.askapollo.com/live/images/doctors/neurosurgery/dr-arvind-sukumaran-neurosurgery-in-chennai..jpg" alt="Doctor">
      <!-- Create a card name -->
      <h1>Dr Arvind Sukumaran</h1>
      <!-- Create a card details -->
      <p>Pulmonology</p>
      <p>5 years of experience</p>
      <p>Vijay Nagar, Indore</p>
    ...
    <div class="card">
      <!-- Create a card picture -->
      <img src="https://cdn.askapollo.com/live/images/doctors/cardiology/dr-b-v-a-ranga-reddy-cardiology-in-hyderabad.png" alt="Doctor">
      <!-- Create a card name -->
      <h1>Dr B V A Ranga Reddy</h1>
      <!-- Create a card details -->
      <p>Rheumatology</p>
      <p>5 years of experience</p>
      <p>Vijay Nagar, Indore</p>
